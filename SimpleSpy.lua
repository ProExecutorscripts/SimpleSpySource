--- START OF FILE SimpleSpy.lua.txt ---
...
local Highlight =
	loadstring(
		game:HttpGet("https://raw.githubusercontent.com/ProExecutorscripts/SimpleSpySource/refs/heads/master/highlight.lua")
	)()
